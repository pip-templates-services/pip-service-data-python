...
@pytest.mark.skipif(not mysql_uri and not mysql_host, reason="JsonMySql connection is not set")
class TestEntitiesJsonMySqlPersistence:
    persistence: EntitiesJsonMySqlPersistence
    fixture: EntitiesPersistenceFixture

    def setup_method(self):
        self.persistence = EntitiesJsonMySqlPersistence()
