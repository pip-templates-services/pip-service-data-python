...
@pytest.mark.skipif(not postgres_uri and not postgres_host, reason="JsonPostgres connection is not set")
class TestEntitiesJsonPostgresPersistence:
    persistence: EntitiesJsonPostgresPersistence
    fixture: EntitiesPersistenceFixture

    def setup_method(self):
        self.persistence = EntitiesJsonPostgresPersistence()
