...
@pytest.mark.skipif(not sqlserver_uri and not sqlserver_host, reason="SqlServer connection is not set")
class TestEntitiesSqlServerPersistence:
    persistence: EntitiesSqlServerPersistence
    fixture: EntitiesPersistenceFixture

    def setup_method(self):
        self.persistence = EntitiesSqlServerPersistence()
